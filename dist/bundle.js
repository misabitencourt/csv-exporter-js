...
var _normalizer = __webpack_require__(4);

var _normalizer2 = _interopRequireDefault(_normalizer);

var _polyfills = __webpack_require__(5);

var _polyfills2 = _interopRequireDefault(_polyfills);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var csvExporter = function csvExporter(data, options) {
    return new Promise(function (resolve) {
        ...
        if (!options.filename) {
            var today = new Date();
            var customName = today.getFullYear() + '-' + (today.getMonth() + 1) + '-' + today.getDate() + '.csv';
        ...
        if (options.header && options.header.length) {
            ...
            stringResult += options.header.map(function (col) {
                return (0, _normalizer2.default)(col, options);
            }).join(options.separator);
            stringResult += options.lineBreak;
        }

        // Data
        stringResult += data.map(function (row) {
        ...
        // Download
        (0, _downloader2.default)(stringResult, options.filename, options.contentType);
...
exports.default = function (data, downloadFileName, contentType) {
...
exports.default = function (col, options) {
